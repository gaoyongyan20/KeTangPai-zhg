...
Page {
    ...
    Rectangle{
        color: "pink"
        width: courseDetail_student.width
        height: courseDetail_student.height-35
        ...
        //这里设置课程相关的详情内容（很多按钮的那里）
        Rectangle{
            width: courseDetail_student.width
            height: courseDetail_student.height*0.8
            anchors.bottom: parent.bottom
            radius: 20  // 圆角半径

            //考勤、表现、成绩、学情分析、错题集的五个按钮的包含Rectangle
            Rectangle{
                width: parent.width
                ...
                Row{
                    ...
                    Column {
                        ...
                        RoundButton {
                            id: s_mistakeLog
                            icon.name: "view-financial-category-edit-symbolic.svg"
                            icon.color: "white"
                            anchors.horizontalCenter: parent.horizontalCenter
                            background: Rectangle {
                                    implicitWidth: 40
                ...
                Row{
                    ...
                    ScrollView{
                        ...
                        ScrollBar.horizontal: ScrollBar {
                            policy: ScrollBar.AsNeeded  // 保留滚动逻辑
                            visible: false              // 完全隐藏（但仍可交互）
                        }
